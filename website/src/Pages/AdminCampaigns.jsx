...
//             <button
//               onClick={logout}
//               className="rounded-xl border border-[#155541] px-5 py-3 font-bold text-[#155541]"
//             >
//               Logout
//             </button>
//           </div>
...
//                     <td className="p-4 font-bold">{campaign.title_en}</td>
//                     <td className="p-4">{campaign.slug}</td>
//                     <td className="p-4">{campaign.type}</td>
//                     <td className="p-4">{campaign.progress}%</td>
