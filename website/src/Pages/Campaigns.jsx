...
// // //     { id: "chess-academy", image: "/campaigns/Chess1_1.png" },
...
// function CampaignSlider({ title, campaigns, emptyText }) {
//   const [index, setIndex] = useState(0);
...
//   return (
//     <article className="group flex min-h-[560px] flex-col overflow-hidden rounded-3xl bg-white shadow-lg ring-1 ring-black/5 transition duration-300 hover:-translate-y-2 hover:shadow-2xl">
